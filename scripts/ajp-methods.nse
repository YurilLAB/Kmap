...
---
-- @usage
-- kmap -p 8009 <ip> --script ajp-methods
--
-- @output
-- PORT     STATE SERVICE
-- 8009/tcp open  ajp13
...
-- |_  See https://github.com/YurilLAB/Kmap/nsedoc/scripts/ajp-methods.html
--
...
action = function(host, port)
  ...
  if ( #interesting > 0 ) then
    ...
    table.insert(output, "See https://github.com/YurilLAB/Kmap/nsedoc/scripts/ajp-methods.html")
  end
