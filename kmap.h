/***************************************************************************
 * kmap.h -- Currently handles some of Kmap's port scanning features as    *
...
#ifndef KMAP_NAME
#define KMAP_NAME "Kmap"
#endif
#define KMAP_URL "https://github.com/YurilLAB/Kmap"
...
#define KMAP_MAJOR 7
#define KMAP_MINOR 99
#define KMAP_BUILD 1
/* SVN, BETA, etc. */
#define KMAP_SPECIAL "SVN"

#define KMAP_VERSION STR(KMAP_MAJOR) "." STR(KMAP_MINOR) KMAP_SPECIAL
#define KMAP_NUM_VERSION STR(KMAP_MAJOR) "." STR(KMAP_MINOR) "." STR(KMAP_BUILD) ".0"
#endif

#define KMAP_XMLOUTPUTVERSION "1.05"
...
/* Number of hosts we pre-ping and then scan.  We do a lot more if
   ...
   extra always-resident memory in kmap */
