...
/* code from Kmap. They should NOT be used in any new piece of code unless   */
/* the code you are writing needs to be shared with kmap.                    */
/*****************************************************************************/
/** Print fatal error messages to stderr and then exits.
 * @warning This function does not return because it calls exit() */
 ...
 * (taken originally from kmap tcpip.cc */
