...
// continue to look for a better match.
  ...
  // The line number of this match in kmap-service-probes.
  int lineno;
...
// Returns the service name this matches
 ...
 private:
  ...
  bool isSoft; // is this a soft match? ("softmatch" keyword in kmap-service-probes)
...
// Amount of time to wait after a connection succeeds (or packet sent) for a responses.
 ...
 private:
  ...
  int probeprotocol;
  std::vector<ServiceProbeMatch *> matches; // first-ever use of STL in Kmap!
};
