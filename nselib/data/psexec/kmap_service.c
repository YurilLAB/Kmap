 ...
 * When Kmap detects the presence of this new file, it is downloaded, then all files, temp files, and
 ...
 * program. By default, at the time of this writing, Kmap appends a .txt extension to the file.
 *
...
static void ServiceMain(int argc, char** argv)
{
	...
	else
	{
		...
		/* Rename the output file (this is what tells Kmap we're done. */
